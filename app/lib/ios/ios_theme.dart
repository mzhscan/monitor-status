...
class IOSTheme {
  ...
  // 用更明显的 solid 浅粉 —— 0x33/0x66 alpha 在白卡上看不清
  // v2.4.27+ 反馈：必须能直接看出总条长度
  // v2.4.28 再深一档：0xFFFFC4D2 还是被绿色 fill 渐变 0.7 alpha 末端糊掉
  static const Color trackBackground = Color(0xFFFFB0C5);
